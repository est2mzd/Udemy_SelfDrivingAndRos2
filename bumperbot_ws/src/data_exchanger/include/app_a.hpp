#ifndef FLAG_VALUE_EXCHANGE_APP_A_HPP_
#define FLAG_VALUE_EXCHANGE_APP_A_HPP_

#include "rclcpp/rclcpp.hpp"  // ROS2のクライアントライブラリ
#include "std_msgs/msg/int32_multi_array.hpp"  // 複数の整数型メッセージを扱うためのメッセージ型

// AppAクラスの定義。ROS2ノードを継承し、flagとvalueを使用した処理を実装
class AppA : public rclcpp::Node
{
public:
    // コンストラクタの宣言
    AppA();
...
#endif  // FLAG_VALUE_EXCHANGE_APP_A_HPP_
